...
createRES_DTE <- function(dds, condition.col, first.level, ref.level, pvalue, gtf_file){
...
run_preprocessing_dte <- function(dds, rld, condition.col, first.level, ref.level, pvalue, gtf_file){
  ...
  res_df = createRES_DTE(dds,condition.col, first.level, ref.level, pvalue, gtf_file)
  print(head(res_df))
  
  dteProcess = list(res_df = res_df, 
                    rld = rld, 
                    dds = dds,
